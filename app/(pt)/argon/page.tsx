...
const serviceGroups = [
  { eyebrow: "Presença externa", title: "Fachadas e identidade", copy: "Peças para tornar sua marca reconhecível logo no primeiro contato.", items: ["Letreiros e logotipos caixa", "Fachadas", "Banners e adesivos"] },
  { eyebrow: "Destaque", title: "Iluminação e luminosos", copy: "Recursos de luz e acabamento para chamar atenção com intenção.", items: ["Neon", "Luminárias em acrílico", "Luminosos"] },
  { eyebrow: "Ambiente", title: "Ponto de venda e orientação", copy: "Elementos que ajudam a apresentar, organizar e direcionar.", items: ["Bandejas e displays", "Sinalização", "Displays para PDV"] },
];
const processSteps = [
