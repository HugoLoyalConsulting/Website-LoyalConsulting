...
const serviceGroups = [
  { eyebrow: "Presença externa", title: "Fachadas e identidade", images: ["argon-01.jpg", "argon-05.jpg"], copy: "Peças para tornar sua marca reconhecível logo no primeiro contato.", items: ["Letreiros e logotipos caixa", "Fachadas", "Banners e adesivos"] },
  { eyebrow: "Destaque", title: "Iluminação e luminosos", images: ["argon-02.jpg", "argon-06.jpg"], copy: "Recursos de luz e acabamento para chamar atenção com intenção.", items: ["Neon", "Luminárias em acrílico", "Luminosos"] },
  { eyebrow: "Ambiente", title: "Ponto de venda e orientação", images: ["argon-03.jpg", "argon-04.jpg"], copy: "Elementos que ajudam a apresentar, organizar e direcionar.", items: ["Bandejas e displays", "Sinalização", "Displays para PDV"] },
];
...
export default function ArgonLandingPage() {
  return (
    <main className="argon-page argon-modern" id="topo">
      ...
      <a className="argon-whatsapp-persistent" href={whatsapp} target="_blank" rel="noopener noreferrer" aria-label="Falar no WhatsApp"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M19.1 4.9A9.9 9.9 0 0 0 2.3 12c0 1.7.4 3.3 1.2 4.7L2 22l5.5-1.4A9.9 9.9 0 1 0 19.1 4.9Zm-7.2 14a6.9 6.9 0 0 1-3.5-1l-.4-.2-3.3.8.9-3.2-.2-.4a6.9 6.9 0 1 1 6.5 3.9Z" fill="currentColor" /></svg></a>
